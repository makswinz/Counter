...
/// COUNTER_DIAG environment variable is set, so production writes nothing.
/// </summary>
public static class Diag
{
    ...
    private static readonly bool ForcedOn =
        !string.IsNullOrEmpty(Environment.GetEnvironmentVariable("COUNTER_DIAG"));
    ...
    /// than assumed. Like the rest of this class it is DEBUG-only unless COUNTER_DIAG is set.
    /// </summary>
