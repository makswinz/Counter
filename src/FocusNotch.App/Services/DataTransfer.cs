...
/// <summary>
/// Getting data out of Focus Notch, and getting a backup back in.
///
...
public static class DataTransfer
{
    ...
    public static bool ApplyPendingRestore()
    {
        try
        {
            ...
            if (File.Exists(live))
            {
                ...
                File.Copy(live, Path.Combine(backups, "focusnotch-before-restore-" + stamp + ".db"), overwrite: true);
            }
    ...
    private static string? Inspect(string path)
    {
        ...
        using (var version = connection.CreateCommand())
        {
            ...
            {
                return "That backup was written by a newer version of Focus Notch.";
            }
        }
