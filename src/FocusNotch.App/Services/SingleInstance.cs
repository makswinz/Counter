...
{
    private const string MutexName = @"Local\FocusNotch.SingleInstance.Mutex";
    private const string SignalName = @"Local\FocusNotch.SingleInstance.Signal";
    ...
    public void SignalExistingInstance()
    {
        ...
        {
            Log.Warn("Could not signal the running Focus Notch instance.", ex);
        }
    }
    ...
    public void ListenForSecondInstance(Action onSignal)
    {
        ...
        {
            IsBackground = true,
            Name = "FocusNotch.SingleInstanceListener"
        };
