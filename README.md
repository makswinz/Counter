...
| **Readable on any wallpaper** | Every ink clears 4.5:1 against the surface it is drawn on, in both themes, on all three materials, over anything you have behind it - measured by photographing the real window over bands of saturated colour, not by hoping. |
